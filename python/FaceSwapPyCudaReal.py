...
while cap.isOpened():   
    ...
    if (len(camera_faces) == 2):
        ...
        img_Out_line1 = FT.FaceSwap_CUDA(img_Out_line, img_Out_line, width_CAM, height_CAM, width_CAM, height_CAM, n_quadrangles, Quadrangles, landmarks_FACE1, landmarks_FACE2)
        img_Out_line2 = FT.FaceSwap_CUDA(img_Out_line1, img_Out_line, width_CAM, height_CAM, width_CAM, height_CAM, n_quadrangles, Quadrangles, landmarks_FACE2, landmarks_FACE1)
